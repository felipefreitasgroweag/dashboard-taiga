...
class TaigaAPI:
    ...
    def authenticate(self):
        ...
        try:
            ...
            st.error(f"Erro ao conectar com Taiga: {str(e)}")
            return False
    ...
    def get_project_data(self, project_id):
        ...
        try:
            ...
            st.error(f"Erro ao buscar dados do projeto: {str(e)}")
            return None
...
def main():
    ...
    if not data:
        st.error("Não foi possível carregar os dados. Verifique suas credenciais.")
        return
    ...
    st.header(f"📋 {project_data.get('name', 'Projeto')}")
