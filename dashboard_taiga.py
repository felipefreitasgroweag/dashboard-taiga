...
def calculate_metrics(all_items, issues, status_order_map):
    metrics = {}
    WIP_STATUSES = ["Backlog", "Semanais/OnGoing", "Refine / Discovery", "UX/UI", "In Progress", "Ajuste", "Impeditivo", "Code Review", "To Do (QA)", "QA em andamento", "Business Review", "Fila de Deploy", "Validação Seara", "Relatórios"]
